...
description: "Use when generating or reviewing Java code that should follow common local standards, Hutool usage, Lombok usage, and shared coding conventions."
---
# Java通用编码规范

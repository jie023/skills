...
description: "Use when reviewing or writing Java code involving collections, concurrency, multithreading, control flow, or thread-safety under Alibaba P3C standards."
---
# P3C 高级编程规范
